...
Sentiment:"""
        ...
        for run in range(NUM_RUNS):
            ...
            print(f"Template {template_id} | Entity: {entity_name} | Run {run + 1} | Predicted: {prediction}")

output = pd.DataFrame(results)
output.to_csv(r'C:\Users\rualryt\OneDrive\Documents\taglish_tosc\results\qwen_ic_results_5runs.csv', index=False)
print("Done!")